        ...
        <form className="w-full space-y-4 flex flex-col">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-md shadow-sm focus:ring-amber-400 focus:ring-2"
              value={tempPassword}
          ...
          <Button
            ...
            className="w-full bg-green-600 hover:bg-green-800 text-white font-bold py-2 px-4 rounded transition duration-200"
          />
        </form>
      </div>
    </div>
